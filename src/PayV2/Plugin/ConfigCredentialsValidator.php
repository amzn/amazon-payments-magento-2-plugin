...
{
    const XML_PATH_API_VERSION = 'groups/amazon_payment/fields/api_version/value';
    const XML_PATH_ACTIVE = 'groups/amazon_payment/groups/credentials/fields/active_v2/value';
    const XML_PATH_PRIVATE_KEY = 'groups/amazon_payment/groups/credentials/fields/private_key/value';
    const XML_PATH_PUBLIC_KEY_ID = 'groups/amazon_payment/groups/credentials/fields/public_key_id/value';
    const XML_PATH_STORE_ID = 'groups/amazon_payment/groups/credentials/fields/store_id/value';
    const XML_PATH_PAYMENT_REGION = 'groups/amazon_payment/groups/credentials/fields/payment_region/value';
    const XML_PATH_SANDBOX = 'groups/amazon_payment/groups/credentials/fields/sandbox/value';
    ...
    protected function getUpdatedConfig(Config $subject)
    {
        ...
        if ($privateKey && (preg_match('/^\*+$/', $privateKey) || $privateKey === $this->amazonConfig->getPrivateKey($scope, $scopeCode))) {
            $privateKey = null;
        }
        ...
        if ($sandbox !== null) {
            $sandbox = boolval($sandbox) !== $this->amazonConfig->isSandboxEnabled($scope, $scopeCode) ? boolval($sandbox) : null;
        }
